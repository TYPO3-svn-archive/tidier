...
***************************************************************/
/**
 * Crawler hook for tidier accessability checks. Works with the "crawler" extension
 *
 */
 ...
 *
 * @package TYPO3
 * @subpackage tx_tidier
 */
class tx_tidier_crawler {
...
if (defined('TYPO3_MODE') && isset($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/tidier/class.crawler.php'])) {
	include_once($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/tidier/class.crawler.php']);
}
